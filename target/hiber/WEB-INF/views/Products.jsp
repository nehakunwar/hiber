...
<table id="myTable" bgcolor="cyan">  
        ...
        <tbody>  
          ...
          <tr>
               <td>${listProduct[0].id}</td>
                <td>${listProduct[0].name}</td>
                <td>${listProduct[0].category}</td>
                <td>${listProduct[0].price}</td>
				<td><a href="edit/${list[0].id}" class="btn btn-primary">EDIT</a></td>
				<td><a href="delete/${list[0].id}" class="btn btn-primary">Delete</a></td>
